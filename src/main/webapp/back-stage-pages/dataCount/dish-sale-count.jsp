...
<head>
    ...
    <title>Delicious on Fingertips | Sale Count</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="../dataCount/data-count.html">数据统计</a></li>
                <li class="active">菜品销量统计</li>
            </ol>
        </section>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">餐馆各菜品销量统计及推荐指数</h3>
                            <%--<div class="pull-right">--%>
                        ...
                        <div class="box-body">
                            <div id="toolbar">
                                <div class="form-horizontal">
                                    <div class="col-sm-12 form-group">
                                        <input id="dishTypeName" type="text" class="col-sm-4 form-control" placeholder="请输入要搜索的菜系" style="width: 200px;">
                                        <div class="col-sm-4">
                            ...
                            <table id="sale-count-table"></table>
                        </div>
                        <!-- /.box-body -->
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        $table = $('#sale-count-table').bootstrapTable({
            contentType: "application/x-www-form-urlencoded",//一种编码。好像在post请求的时候需要用到。这里用的get请求，注释掉这句话也能拿到数据
            url:"http://192.168.1.180:8080/doft/manage/sale/getDishSalePages.aj",//要请求数据的文件路径
            ...
            columns: [
                ...
                { title: '菜品ID', field: 'dishId'},
                { title: '菜品名', field: 'dishName'},
                { title: '所属菜系',field: 'dishTypeName'},
                { title: '总销量', field: 'totalSales'},
                { title: '推荐指数', field:'recommendIndex',formatter: function (value, row, index) {
                    var intPart = parseInt(value);
                    var shtml = value+" / ";
                    for(var i=0;i<intPart;i++){
                        shtml+="<i class='fa fa-star text-yellow'></i>";
                    }
                    if(parseFloat(value)!=intPart){
                        shtml+="<i class='fa fa-star-half-empty text-yellow'></i>";
                    }
                    return shtml;
                }}
            ]
...
//请求成功方法
        ...
        $('#search').click(function () {
            var dishTypeName = $('#dishTypeName').val();
            $('#sale-count-table').bootstrapTable('refresh', { url: 'http://192.168.1.180:8080/doft/manage/sale/getDishSalePages.aj?dishTypeName=' + dishTypeName});
        });
        $('#reset').click(function() {
            $('#dishTypeName').val('');
            //刷新表格数据,点击重置按钮调用这个方法就可以刷新
            $('#sale-count-table').bootstrapTable('refresh', { url: 'http://192.168.1.180:8080/doft/manage/sale/getDishSalePages.aj' });
        });
